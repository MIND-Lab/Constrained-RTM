...
public class SLDA extends LDA {
	...
	protected double topicUpdating(int doc, int topic, int vocab) {
		...
		if (labelStatuses[doc]) {
			...
			score *= Math.exp(-MathUtil.sqr(weight - eta[topic] / corpus.get(doc).docLength())
	 ...
	 * 
	 * @param predLabelFileName
	 *            Predicted label file name
	 * @throws IOException
	 *             IOException
	 */
	...
	/**
	 * Select words with weights higher than $posWeightThreshold or lower than
	 * $negWeightThreshold
	 * 
	 * @param wordWeights
	 *            Word weights
	 * @param posWeightThreshold
	 *            Positive word threshold
	 * @param negWeightThreshold
	...
	/**
	 * Sort the words with weights and select $posNum in the top and $negNum in the
	 * bottom
	 * 
	 * @param wordWeights
	 *            Word weights
	 * @param posNum
	 *            Number of words in the top
	 * @param negNum
	 *            Number of words in the bottom
	 * @return Set of selected words
	 */
	...
	/**
	 * Select topics with weights higher than $posWeightThreshold or lower than
	 * $negWeightThreshold
	 * 
	 * @param topicWeights
	 *            Topic weights
	 ...
	 */
	public Set<SLDATopicWeight> selectTopics(double topicWeights[], double posWeightThreshold,
			double negWeightThreshold) {
	...
	/**
	 * Sort the topics with weights and select $posNum in the top and $negNum in the
	 * bottom
	 * 
	 * @param topicWeights
	 *            Topic weights
	 * @param posNum
	 *            Number of topics in the top
	 * @param negNum
	 *            Number of words in the bottom
	 * @return Set of selected topics
	 */
	...
	/**
	 * Select words with weights higher than $posWeightThreshold or lower than
	 * $negWeightThreshold from selected topics
	 * 
	 * @param selectedTopics
	 *            Set of selected topics
	 * @param posWeightThreshold
	 *            Positive weight threshold
	 * @param negWeightThreshold
	 *            Negative weight threshold
	 * @return Set of selected words
	 */
	public Set<LDAWord> selectWordsFromTopics(Set<SLDATopicWeight> selectedTopics, double posWeightThreshold,
			double negWeightThreshold) {
		Set<LDAWord> wordSet = new HashSet<LDAWord>();
